...
options.subscribe(
    (value) => (localStorage.storedOptions = JSON.stringify(value))
)
...
language.subscribe(
    (value) => (localStorage.storedLanguage = JSON.stringify(value))
)
...
export let preFormErrors = writable({ // aka Errors
    latlon: false,
    date: false,
    startTime: false,
    duration: false,
