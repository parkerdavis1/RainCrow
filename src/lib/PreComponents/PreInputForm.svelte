<script>
    ...
    // Components
    import FormLocate from './FormLocate.svelte';
    import FormDate from './FormDate.svelte';
    import FormStartTime from './FormStartTime.svelte';
    import FormDuration from './FormDuration.svelte';
    ...
    const handleGetWeather = async () => {
        ...
        times.end.localTime = dayjs(times.start.localTime).add(
            $preFormInput.duration,
            'minute'
        );
        try {
